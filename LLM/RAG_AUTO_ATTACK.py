...
class RAG_Judge_Agent:
    ...
    def _build_graph(self):
        ...
        graph_builder.add_node("attack_node", self._attack_node)

        graph_builder.add_edge(START, "attack_node")
        graph_builder.add_edge("attack_node", "rag_retrieve_node")
        graph_builder.add_edge("rag_retrieve_node", "rag_retrieve_node")
    ...
    def _attack_node(self,state: State):
        pass
